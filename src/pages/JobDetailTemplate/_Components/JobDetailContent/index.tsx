...
export default function JobDetailContent({item}: JobDetailProp) {
    return (
        <>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 border-b border-[#e4e5e7] pb-6">
                ...
                <div className="flex-1">
                    <div className="flex flex-wrap items-center gap-3">
                        <span className="text-[24px] font-semibold text-[#222325]">{ item.tenNguoiTao }</span>
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2 text-[18px]">
                        ...
                        <span className="font-bold text-[#222325]">{`${item.congViec.saoCongViec}.0`}</span>
